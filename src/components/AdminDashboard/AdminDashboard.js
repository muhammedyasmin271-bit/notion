        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8">
            <StatCard
              ...
              icon={Users}
              color="bg-blue-500"
              change={stats.growthMetrics?.weekly || 0}
            />
            <StatCard
              title="Active Users"
          ...
          {/* System Stats and Recent Activity */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
            {/* System Stats */}
            <div className={`lg:col-span-1 rounded-2xl shadow-lg p-6 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
            ...
            {/* Recent Activity */}
            <div className={`lg:col-span-2 rounded-2xl shadow-lg p-6 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
              <h2 className="text-xl font-bold mb-6">Recent Activity</h2>
              <div className="space-y-4">
                {recentActivity.map(activity => (
                  <div key={activity.id} className="flex items-start">
                    <div className={`p-2 rounded-lg mr-4 ${activity.type === 'project' ? 'bg-blue-100 text-blue-600' :
                    ...
                    <span className={`text-sm ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>{activity.time}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
            {/* Role Distribution */}
            <div className={`rounded-2xl shadow-lg p-6 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
              ...
              <div className="flex items-center justify-center h-64">
                <div className="relative w-48 h-48">
                  ...
                  <div className="absolute inset-0 rounded-full border-8 border-red-500 transform rotate-45"></div>
              ...
              <div className="flex justify-center space-x-6 mt-4">
                <div className="flex items-center">
                  ...
                  <span className="text-sm">Users ({stats.roleDistribution?.users || 0})</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 bg-purple-500 rounded mr-2"></div>
                  <span className="text-sm">Managers ({stats.roleDistribution?.managers || 0})</span>
                </div>
                <div className="flex items-center">
                  <div className="w-4 h-4 bg-red-500 rounded mr-2"></div>
                  <span className="text-sm">Admins ({stats.roleDistribution?.admins || 0})</span>
                </div>
              </div>
            </div>
            ...
            <div className={`rounded-2xl shadow-lg p-6 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
              ...
              <div className="h-64 flex items-end space-x-2 justify-center">
                {[10, 25, 40, 30, 55, 45, 60, 50, 70, 65, 80, 75].map((height, index) => (
                  <div key={index} className="flex flex-col items-center">
                    <div
                      className="w-6 bg-gradient-to-t from-blue-500 to-blue-300 rounded-t"
                      style={{ height: `${height}%` }}
                    ></div>
                    <span className="text-xs mt-2">{['J', 'F', 'M', 'A', 'M', 'J', 'J', 'A', 'S', 'O', 'N', 'D'][index]}</span>
                  </div>
                ))}
              </div>
          ...
          <div className={`rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 mb-6 sm:mb-8 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
              <button
                ...
                className={`p-6 rounded-xl flex flex-col items-center justify-center transition-transform hover:scale-105 ${isDarkMode ? 'bg-gray-700 hover:bg-gray-600' : 'bg-gray-100 hover:bg-gray-200'}`}
              >
                <Users className="w-8 h-8 text-blue-500 mb-3" />
                <span className="font-medium">User Analytics</span>
              </button>
              <div className={`p-6 rounded-xl flex flex-col items-center justify-center ${isDarkMode ? 'bg-gray-700' : 'bg-gray-100'}`}>
                <BarChart3 className="w-8 h-8 text-green-500 mb-3" />
                <span className="font-medium">Project Metrics</span>
              </div>
              <div className={`p-6 rounded-xl flex flex-col items-center justify-center ${isDarkMode ? 'bg-gray-700' : 'bg-gray-100'}`}>
                <Calendar className="w-8 h-8 text-purple-500 mb-3" />
                <span className="font-medium">Meeting Insights</span>
              </div>
              <div className={`p-6 rounded-xl flex flex-col items-center justify-center ${isDarkMode ? 'bg-gray-700' : 'bg-gray-100'}`}>
                <FileText className="w-8 h-8 text-red-500 mb-3" />
                <span className="font-medium">Document Analytics</span>
              </div>
            </div>
          </div>

          {/* System Tools */}
          <div className={`rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <div className={`p-6 rounded-xl ${isDarkMode ? 'bg-gray-700' : 'bg-gray-100'}`}>
                ...
                <p className={`mb-4 text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  Export user data, reports, and system logs in various formats.
                </p>
              ...
              <div className={`p-6 rounded-xl ${isDarkMode ? 'bg-gray-700' : 'bg-gray-100'}`}>
                ...
                <p className={`mb-4 text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  Reset system settings or clear cache (use with caution).
                </p>
