...
const AIAssistant = () => {
  ...
  return (
    <>
      ...
      {/* AI Popup */}
      {showAIPopup && (
        <div className={`fixed bottom-24 right-6 z-[9999] w-96 max-h-[500px] rounded-xl shadow-2xl border transition-all duration-200 transform animate-in slide-in-from-bottom-2 ${
          isDarkMode 
          ...
          <div className="p-4">
            ...
            {(aiResponse || isGenerating) && (
              <div className={`mt-3 p-3 rounded-lg border max-h-60 overflow-y-auto ${
                isDarkMode 
