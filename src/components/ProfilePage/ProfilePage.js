            ...
            {tabs.map(tab => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center justify-center gap-1 sm:gap-2 px-3 sm:px-4 py-3 sm:py-4 font-medium transition-all duration-200 min-h-[52px] sm:min-h-[60px] flex-1 text-center whitespace-nowrap min-w-0 ${
                    activeTab === tab.id 
