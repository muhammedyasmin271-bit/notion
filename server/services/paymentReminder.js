    ...
    if (delayMs > 0) {
      const timeoutId = setTimeout(async () => {
        try {
          ...
          const message = `⏰ Payment Reminder: ${companyName} - You have ${hoursRemaining} hours to complete payment before your company is suspended. Login: http://localhost:3000/login?company=${companyId}`;
